      ...
      {categories.map(category => {
        ...
        return (
          <SmartLink
            ...
            passHref
            className={(selected
              ? 'hover:text-white dark:hover:text-white bg-blue-dark text-white '
              : 'dark:text-gray-400 text-gray-500 hover:text-white dark:hover:text-white hover:bg-blue-dark') +
