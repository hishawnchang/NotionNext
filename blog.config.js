...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'Patent lawyer', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://scienovus.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Patent, Investment', // 网站关键词 英文逗号隔开
